...
public class Campominato extends Activity implements OnClickListener
{
    	...
    	public void onCreate(Bundle savedInstanceState) 
    	{
    			...
    			setContentView(R.layout.activity_campominato);
    	...
    	{
    			getMenuInflater().inflate(R.menu.campominato, menu);
    			return true;
    	}
